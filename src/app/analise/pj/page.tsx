import { AnalysePJForm } from "@/components/forms/AnalysePJForm";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Nova Análise PJ | Motor de Crédito",
};

export default function AnalysePJPage() {
  return (
    <div className="page-container">
      <div className="page-intro">
        ...
        <p className="page-description">
          Preencha os dados da empresa para calcular o score de crédito baseado nos 6 Cs.
